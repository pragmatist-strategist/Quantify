...
import com.pranav.quantify.NotificationService;
import com.pranav.quantify.R;

//Notification Drawer activity.


public class NotificationsDrawer extends com.pranav.quantify.drawers.Drawer {
...
//onDestroy.
    ...
    //Fetch the rectangle's height in various directions.
    ...
    public void draw(Canvas c) {
        ...
        if (!NotificationService.permissionsGranted) {
            text1 = "Please open the Quantify application";
